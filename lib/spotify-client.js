...
function Client () {
    ...
    // Class.prototype.namespace = { method: function } - gets 
    // 'this' wrong because of the object-literal. But I like the way it looks,
    // so here's some wonky method definitions
    var self = this;
    this.queue = {
        tracks  : function () {
